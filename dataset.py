...
class EORSSD(data.Dataset):
    def __init__(self, root, mode, aug=False):
        ...
        self.image_transformation = transforms.Compose([transforms.ToTensor(), transforms.Normalize(self.dt_mean, self.dt_std)])
        self.label_transformation = transforms.ToTensor()
